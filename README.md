...
| **20+ Languages** | TypeScript, JavaScript, Python, Go, Rust, Java, C#, PHP, Ruby, C, C++, Objective-C, Swift, Kotlin, Scala, Dart, Lua, Luau, R, Verilog, SystemVerilog, Svelte, Vue, Astro, Liquid, Pascal/Delphi |
